...
public class CrudRepository {
    ...
    public Integer create(String tableName, JSONObject body) {
        ...
        var prim_key = dao.fetchObject("SELECT cols.column_name FROM all_constraints cons, all_cons_columns cols WHERE cols.table_name = "+tableName+" AND cons.constraint_type = 'P' AND cons.constraint_name = cols.constraint_name AND cons.owner = cols.owner ORDER BY cols.table_name, cols.position", String.class);
