...
import com.bdas2.app.repository.modelRepositories.ZastavkaLinkaRepository;
...
@CrossOrigin
@RestController
@RequestMapping("/zastavkalinka")
public class ZastavkaLinkaController {
    public final ZastavkaLinkaRepository repo;

    public ZastavkaLinkaController(ZastavkaLinkaRepository repo) {
        this.repo = repo;
    }
    ...
    @PostMapping("/create")
    @ResponseBody
    public ResponseEntity create(@RequestBody Zastavka_Linka body) {
        try {
    ...
    @PostMapping("/update")
    public ResponseEntity update(@RequestParam Integer id, @RequestBody Zastavka_Linka body) {
        try {
