...
@CrossOrigin
@RestController
@RequestMapping("/JizdniRad")
public class JizdniRadController {
    public final JizdniRadRepository repo;

    public JizdniRadController(JizdniRadRepository repo) {
        this.repo = repo;
    }
    ...
    @PostMapping("/create")
    @ResponseBody
    public ResponseEntity create(@RequestBody Jizdni_Rad body) {
        try {
    ...
    @PostMapping("/update")
    public ResponseEntity update(@RequestParam Integer id, @RequestBody Jizdni_Rad body) {
        try {
