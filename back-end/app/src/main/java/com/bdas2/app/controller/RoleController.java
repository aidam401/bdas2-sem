...
import com.bdas2.app.repository.modelRepositories.RoleRepository;
...
public class RoleController {
    public final RoleRepository repo;
    ...
    @PostMapping("/update")
    public ResponseEntity update(@RequestParam Integer id, @RequestBody Role body) {
        try {
