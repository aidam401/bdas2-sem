...
import com.bdas2.app.repository.modelRepositories.VozidloRepository;
...
public class VozidloController {
    public final VozidloRepository repo;

    public VozidloController(VozidloRepository repo) {
        this.repo = repo;
    }
    ...
    @PostMapping("/create")
    @ResponseBody
    public ResponseEntity create(@RequestBody Vozidlo body) {
        try {
    ...
    @PostMapping("/update")
    public ResponseEntity update(@RequestParam Integer id, @RequestBody Vozidlo body) {
        try {
