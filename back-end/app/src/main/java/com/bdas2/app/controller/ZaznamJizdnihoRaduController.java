...
@CrossOrigin
@RestController
@RequestMapping("/ZaznamJizdnihoRadu")
public class ZaznamJizdnihoRaduController {
    public final ZaznamJizdnihoRaduRepository repo;

    public ZaznamJizdnihoRaduController(ZaznamJizdnihoRaduRepository repo) {
        this.repo = repo;
    }
    ...
    @PostMapping("/create")
    @ResponseBody
    public ResponseEntity create(@RequestBody Zaznam_Jizdniho_Radu body) {
        try {
