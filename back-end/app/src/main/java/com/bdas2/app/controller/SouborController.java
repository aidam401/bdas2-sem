...
import com.bdas2.app.repository.modelRepositories.SouborRepository;
...
@CrossOrigin
@RestController
@RequestMapping("/Soubor")
public class SouborController {
    public final SouborRepository repo;

    public SouborController(SouborRepository repo) {
        this.repo = repo;
    }
    ...
    @PostMapping("/create")
    @ResponseBody
    public ResponseEntity create(@RequestBody Soubor body) {
        try {
    ...
    @PostMapping("/update")
    public ResponseEntity update(@RequestParam Integer id, @RequestBody Soubor body) {
        try {
