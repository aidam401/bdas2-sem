...
import com.bdas2.app.repository.modelRepositories.PoziceZamestnanceRepository;
...
@CrossOrigin
@RestController
@RequestMapping("/PoziceZamestnance")
public class PoziceZamestnanceController {

    final PoziceZamestnanceRepository repo;

    public PoziceZamestnanceController(PoziceZamestnanceRepository repo) {
        this.repo = repo;
    }
    ...
    @PostMapping("/create")
    @ResponseBody
    public ResponseEntity create(@RequestBody Pozice_Zamestnance body) {
        try {
    ...
    @PostMapping("/update")
    public ResponseEntity update(@RequestParam Integer id, @RequestBody Pozice_Zamestnance body) {
        try {
